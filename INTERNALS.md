...
the detailed version: what was already in the host, what had to be built, and the
one discovery that made the rest possible. the [README](README.md) is the plain
version. start there if you haven't.
